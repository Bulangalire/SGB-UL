...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  console.log(labels); // Create the chart.js data structure using 'labels' and 'data'
