(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/chartDetailRecette"],{

/***/ "./assets/js/chartDetailRecette.js":
/*!*****************************************!*\
  !*** ./assets/js/chartDetailRecette.js ***!
  \*****************************************/
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  var ctxrecette = $("#myDetailRecette"); //chartDetailRecette("Recette", montantrecette, daterecette, ctxrecette,'bar');
  ...
  myRecettes = $("#mesRecettes").data('recettes'); // Split timestamp and data into separate arrays
  ...
  var ctx = document.getElementById("mesRecettes").getContext("2d"); // Instantiate a new chart
...
function chartDetailRecette(titre, montantprevision, daterecette, ctx, typeChart) {
  ...
  var recettes = {
    labels: daterecette,
    datasets: [{
      backgroundColor: ['rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)', 'rgba(255, 159, 64, 0.2)'],
